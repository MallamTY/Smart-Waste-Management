...
const emailOTPTemplate = function (otp, username) {
    const html = `
    <!DOCTYPE html>
    ...
    <body
      ...
      <div style="display: none;">A request to sign in to your account on the Smart Waste System was made, use the one-time-password below to login
      </div>
                      ...
                      <tr>
                        <td class="sm-px-24"
                          ...
                          <p style="margin: 0 0 24px;">
                           <br>A request to sign in to your account on Smart Waste System, use the one-time-password below to login
                          </p>
                        ...
                        <p style="margin: 0 0 16px;">Thanks, <br>Smart Waste System Support Team</p>
