...
const emailTemplate = function (token, username) {
    const html = `
    <!DOCTYPE html>
    ...
    <body
      ...
      <div style="display: none;">A request to sigup on Smart Waste System was made </div>
                      ...
                      <tr>
                        <td class="sm-px-24"
                          ...
                          <p style="margin: 0 0 24px;">
                            <br> A request to sign up on Smart Waste System was made, click on the verification link to verify your account
                          </p>
