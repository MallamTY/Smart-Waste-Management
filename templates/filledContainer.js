...
const filledContainerTemplate = function (leaderName, location, link) {
    const html = `
    <!DOCTYPE html>
    ...
    <body
      ...
      <div style="display: none;">Filed Container </div>
      <div role="article" aria-roledescription="email" aria-label="Filled COntaine" lang="en">
                      ...
                      <tr>
                        <td class="sm-px-24"
                          style="--bg-opacity: 1; background-color: #ffffff;  border-radius: 4px; font-family: Montserrat, -apple-system, 'Segoe UI', sans-serif; font-size: 14px; line-height: 24px; padding: 48px; text-align: left; --text-opacity: 1; color: #626262;"
                           align="left">
                          <p style="font-weight: 600; font-size: 18px; margin-bottom: 0;">Dear ${leaderName},</p>
                          <p style="margin: 0 0 24px;">
                            <br> Container at <strong> ${location} </strong> is filled and needs to be evacuated. Please click on this link ${link} to get the location
                          </p>
                          ...
                          <p style="margin: 0 0 16px;">
                            For further assistance as regards this task, please contact us at
                          ...
                          <p style="margin: 0 0 16px;">Thanks, <br>Smart Waste Systsem Support Team</p>
                        </td>
                      </tr>
                      <tr>
...
export default filledContainerTemplate;