...
const passwordResetTemplate = function (token, username) {
    const html = `
    <!DOCTYPE html>
    ...
    <body
      ...
      <div style="display: none;">A request to sigup on the Smart Waste System was made </div>
                      ...
                      <tr>
                        <td class="sm-px-24"
                          ...
                          <p style="margin: 0 0 24px;">
                            <br> A request to reset your password on the Smart Waste System was made, click on the link below to reset your password.
                          </p>
